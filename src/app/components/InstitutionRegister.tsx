      ...
      <div className="min-h-screen flex items-center justify-center px-4 py-20" style={{ background: "#0a0819" }}>
        <div className="text-center max-w-md flex flex-col items-center gap-6">
          ...
          <div className="p-3 rounded-xl w-full" style={{ background: "rgba(126,200,227,0.06)", border: "1px solid rgba(126,200,227,0.15)" }}>
            <p className="text-xs" style={{ color: "#6060a0" }}>注册钱包地址</p>
            ...
            <div key={i} className="flex items-center">
              ...
              {i < STEPS.length - 1 && (
                <div className="w-16 h-px mx-2 mb-6"
                  style={{ background: i < step ? "rgba(126,200,227,0.5)" : "rgba(255,255,255,0.08)" }} />
              )}
            </div>
          ))}
        </div>
              ...
              <div className="p-5 rounded-2xl space-y-3"
                ...
                {[
                  ...
                  <div key={item.label} className="flex justify-between">
                    <span className="text-sm" style={{ color: "#6060a0" }}>{item.label}</span>
                    <span className="text-sm" style={{ color: "#e8e8f0" }}>{item.val || "（未填写）"}</span>
                  </div>
                ))}
