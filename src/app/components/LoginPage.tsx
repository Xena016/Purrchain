  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-20" style={{ background: "#0a0819" }}>
      ...
      <div className="relative w-full max-w-md">
        {/* Card */}
        <div className="p-8 rounded-3xl" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(126,200,227,0.15)", backdropFilter: "blur(20px)" }}>
          {/* Logo */}
          <div className="flex flex-col items-center gap-3 mb-8">
            ...
            <h1 className="text-2xl" style={{ color: "#fff", fontWeight: 800 }}>欢迎回来</h1>
            <p className="text-sm text-center" style={{ color: "#6060a0" }}>登录您的 PurrChain 账户，连接钱包后开始养猫之旅</p>
          </div>

          <form onSubmit={handleLogin} className="flex flex-col gap-5">
            {/* Email */}
            <div className="flex flex-col gap-2">
              <label className="text-sm" style={{ color: "#9090b0" }}>电子邮箱</label>
              <div className="relative">
                <Mail size={16} className="absolute left-3 top-1/2 -translate-y-1/2" style={{ color: "#6060a0" }} />
                <input
                  type="email"
                  value={email}
            ...
            {/* Password */}
            <div className="flex flex-col gap-2">
              <label className="text-sm" style={{ color: "#9090b0" }}>密码</label>
              <div className="relative">
                <Lock size={16} className="absolute left-3 top-1/2 -translate-y-1/2" style={{ color: "#6060a0" }} />
                <input
                ...
                <button type="button" onClick={() => setShowPw(!showPw)}
                  className="absolute right-3 top-1/2 -translate-y-1/2" style={{ color: "#6060a0", cursor: "pointer" }}>
          ...
          <div className="mt-6 flex flex-col gap-3">
            ...
            <p className="text-center text-sm" style={{ color: "#6060a0" }}>
              <Link to="/" style={{ color: "#6060a0" }}>← 返回首页</Link>
            </p>
          </div>
        </div>

        {/* Info box */}
        <div className="mt-4 p-4 rounded-2xl text-sm" style={{ background: "rgba(247,165,65,0.08)", border: "1px solid rgba(247,165,65,0.2)", color: "#9090b0" }}>
